...
class Collection {
    ...
    async createDatabase () {
        await localStorage.setItem(this.dbName, JSON.stringify({}));
        return this.getDatabase();
    }
    async getDatabase () {
        return new Promise(async(resolve, reject) => {
            let database = await localStorage.getItem(this.dbName);
            if (database) {
        ...
        return new Promise(async(resolve, reject) => {
            try {
                ...
                if (canInsert) {
                    ...
                    await localStorage.setItem(this.dbName, JSON.stringify(database));
                    resolve(data);
                }
            } catch (error) {
